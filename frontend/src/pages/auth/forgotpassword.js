...
import {  FormItemForgotPassword } from '@/components/sections/sections/FormItemForgotPassword'
              ...
              <div className="flex flex-col md:flex-row">
                  ...
                  <div className="col-start-1 col-span-1 ">   
                    ...
                    <div className="col-start-1 col-span-1 m-5"> 
                        ...
                        <p className="m-5">Enter your email address to reset your password</p>

                        <FormItemForgotPassword  /> 
