...
import {getStrapiURL, getCollectionNavigation} from "utils/api";
import { CaretLeftFilled, CaretRightFilled } from '@ant-design/icons';
import { Button, Space } from 'antd';
import { linstance } from "utils/axioapi";


const NextPageReference = () => {   
                  ...
                  getCollectionNavigation({
                    NCollection: IdCollection ? IdCollection : '0' , //28 29        
                        ...
                        keys.masters.data?.map((dataRef, index) => {    
                            const dataObj = {
                                title: dataRef.attributes.referencia,
                                href: dataRef.attributes.referencia,
                            }
...
export default NextPageReference