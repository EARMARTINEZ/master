...
const CarouselStamp = ({StampPicture}) => {   
  ...
  return (  
    ...
    <>      
            ...
            <div className="grid grid-cols-1 gap-1 m-0">        
                ...
                <Modal title="" open={isModalStampOpen} footer={null} onOk={handleOk} onCancel={handleCancel}>                          
                          ...
                          {StampPicture?.map((picture_url) => (                              
                              <div  >
                                <h3 ><ImgReference   key={ picture_url.attributes.url} url={picture_url.attributes.url} UrlId={picture_url.id} />   </h3>  
