...
export function FormItemStampStatus() {   
  ...
  ReferenceMap?.map((Status, index) => {      
     status = Status.attributes.stamp.data ? Status.attributes.stamp.data.attributes.status : 'null'
...
console.log(status)
   ...
   const { data: session } = useSession();   
    ...
    const handleChange = (value) => {
        ...
        doupdateStatusStamp({ "status":value });  
