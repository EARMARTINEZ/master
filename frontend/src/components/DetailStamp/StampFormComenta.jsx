...
const Comenta = () => {
  ...
  const onReset = () => {
   ...
   const { RefeCommentstamp, doUpdateStampComment } = useTasks(); 
   ...
   let ComentaObj= [];
   RefeCommentstamp?.map((Comments, index) => {    
    ...
    const handleSubmit = (values) => {     
      ...
      //console.log(values)
        ...
        setSubmitting(true);
        setTimeout(() => {
            doUpdateStampComment(value,'Showroom', values);
              onReset();
              setSubmitting(false);
              setValue('');      
              setComments([
...
export function StampFormComenta() { 
