...
import SearchCollection from '@/components/Cards/SearchCollection/SearchCollection'
import {FormCreateReferenceDrawer} from '@/components/Cards/CardForm/FormCreateReferenceDrawer'
...
const navigation = [
  {
    title: 'Options:',
    links: [
      { title: 'Master List', href: '/' },
      { title: 'Stamps', href: '/docs/filterstable-stamps' },

      { title: 'Recent Pendings', href: '/docs/recent-pendings' },
