...
if(EntryCount){
    ...
    data.pendings?.map((Comments, index) => {
      ...
      let masterlist = {
        ...
        "color": data.color_pantone ? data.color_pantone.name : '',
        "SystemColor": data.Composition.color ? data.Composition.color.name : '',
        "Size":CodigoSizes.join(' '),
        "Theme": data.theme ? data.theme.name : '',
        "Gender": data.Composition.gender ? data.Composition.gender.name : '',
        "Product": data.Composition.typeproduct ? data.Composition.typeproduct.name : '',
        "Fabric": data.Composition.fabric ? data.Composition.fabric.name : '',
        "Status": data.status,
